                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            <div class="col-lg-6">
                                ...
                                <x-input type="text" wire:model.defer="product.name_en" field='product.name_en'
                                    placeholder="{{__('Enter English Name')}}" />
                            </div>
                            <div class="col-lg-6">
                                <x-label>{{__("Dutch Name")}}</x-label>
                                <x-input type="text" wire:model.defer="product.name_nl" field='product.name_nl'
                        ...
                        <div class="form-group row">
                            <div class="col-lg-6">
                                ...
                                <x-textarea wire:model.defer="product.description_en" field='product.description_en'></x-textarea>
                            </div>
                            <div class="col-lg-6">
                                <x-label>{{__("Dutch Description")}}</x-label>
                                <x-textarea wire:model.defer="product.description_nl" field='product.description_nl'></x-textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-lg-6">
                                <x-label>{{__("Weight")}}</x-label>
                                <x-input type="text" wire:model.defer="product.weight" field='product.weight'
                                    placeholder="{{__('Enter Weight')}}" />
                            </div>
                            <div class="col-lg-6">
                                <x-label>{{__("Size")}}</x-label>
                                <x-input type="text" wire:model.defer="product.size" field='product.size'
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <select class="form-control" wire:model="product.category_id">
